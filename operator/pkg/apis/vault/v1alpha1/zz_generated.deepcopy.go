		...
		*out = make(map[string]Config, len(*in))
		for key, val := range *in {
			if val == nil {
				...
				(*out)[key] = val.DeepCopyConfig()
			}
		}
	}
	if in.ExternalConfig != nil {
		in, out := &in.ExternalConfig, &out.ExternalConfig
		*out = make(map[string]ExternalConfig, len(*in))
		for key, val := range *in {
			if val == nil {
				(*out)[key] = nil
			} else {
				(*out)[key] = val.DeepCopyExternalConfig()
			}
		}
	}
...
func (in *VaultSpec) DeepCopyConfig() Config {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyExternalConfig is an autogenerated deepcopy function, copying the receiver, creating a new ExternalConfig.
func (in *VaultSpec) DeepCopyExternalConfig() ExternalConfig {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
